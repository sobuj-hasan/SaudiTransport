...
<html>
    <head>
        <meta charset="utf-8" />
        <title> @yield('title') - Saudi Chauff</title>
        ...
        <div id="wrapper">
            ...
            <div class="topbar">
                ...
                <div class="topbar-left">
                    <a href="{{ route('admin.index') }}" class="logo">
                        <span>
                            <h4 class="text-white pt-2"><strong>Saudi Chauff </strong></h4>
                        </span>
                        <i>
                ...
                <div class="slimscroll-menu" id="remove-scroll">
                    ...
                    <div id="sidebar-menu">
                        ...
                        <ul class="metismenu" id="side-menu">
                            ...
                            <li>
                                <a href="javascript: void(0);"><i class="far fa-question-circle"></i> <span> Contact Message </span> <span class="menu-arrow"></span></a>
                                <ul class="nav-second-level" aria-expanded="false">
            ...
            <div class="content-page">
                ...
                <footer class="footer text-right">
                    @php echo date('Y'); @endphp © Saudi Chuaff
                </footer>
